import {
  ...
  Leaf, Tree, Flower, Bug, Fish, Bird, Cat, Dog, Rabbit, Star,
  ...
  Dumbbell, Bike, Football, Basketball, Tennis, Golf, Swimming,
  Shirt, Hat, Shoe, Glasses, Watch, Ring, Necklace, Bag,
  Baby, Users2, UserPlus, UserMinus, UserCheck, UserX, Group,
  Truck, Package2, Boxes, Warehouse, Package, Box, Clipboard,
  Award, Medal, Certificate, Badge, Ribbon, Rosette, Flag,
  Recycle, Trash, Archive, Folder, File, Upload, Download,
  ...
  Clock, Timer, Stopwatch, AlarmClock, Hourglass, Calendar as CalendarIcon,
  Phone, MessageCircle, AtSign, Send, Inbox, Outbox, Archive as ArchiveIcon,
  Share, Like, Dislike, ThumbsUp, ThumbsDown, Heart as HeartIcon,
  Sprout, Seedling, TreePine, Cactus, Cherry, Grape, Banana,
  Wrench, Hammer, Screwdriver, Drill, Saw, Pickaxe, Shovel,
  Paintbrush, PaintBucket, Spray, Eraser, Highlighter, Marker, Crayon
} from 'lucide-react';
